...
{
    public partial class RollOff_DBContext : DbContext
    {
        public RollOff_DBContext()
        {
        }

        public RollOff_DBContext(DbContextOptions<RollOff_DBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LIN22006027\\SQLEXPRESS;Database=RollOff_DB;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FeedbackForm>(entity =>
            {
                ...
                entity.HasOne(d => d.GlobalGroup)
                    ...
                    .HasConstraintName("FK__FeedbackF__Globa__37A5467C");
            });

            modelBuilder.Entity<RollOffTable>(entity =>
            {
                entity.HasKey(e => e.GlobalGroupId)
                    .HasName("PK__RollOffT__A8B3AC1AAE6BBC3F");
