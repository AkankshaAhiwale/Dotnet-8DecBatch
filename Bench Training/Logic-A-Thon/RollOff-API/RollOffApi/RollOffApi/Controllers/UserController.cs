...
namespace RollOffApi.Controllers
{
    ...
    {
        private readonly RollOff_DBContext _authContext;
        
        public UserController(RollOff_DBContext ourExcelData)
        {
        ...
        public async Task<IEnumerable<User>> GetUsers() {
            ...
            {
                return (IEnumerable<User>)BadRequest("Something went wrong"+ex);
            }
        }
